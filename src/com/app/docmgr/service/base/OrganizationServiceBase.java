...
public class OrganizationServiceBase {
	private static Logger log = Logger.getLogger("com.app.docmgr.service.base.OrganizationServiceBase");	
	// private static OrganizationServiceBase instance = null;
	 ...
	 */
	 /*
	public static synchronized OrganizationServiceBase getInstance(){
		if(instance == null){
			instance = new OrganizationServiceBase();
		}
		return instance;
	}
	*/
	 ...
	 */
	public Organization getBy(String filterParam) throws Exception{
		Organization organization = null;
		Session session = ConnectionFactory.getInstance().getSession();
		try {
	...
	public void add(Organization organization, Session session) throws Exception {
		Transaction trx = null;
		try	{
			trx = session.beginTransaction();
			session.save(organization);
	...
	public void update(Organization organization, Session session) throws Exception {
		Transaction trx = null;
		try	{
			trx = session.beginTransaction();
			session.saveOrUpdate(organization);
	...
	public void delete(Organization organization, Session session) throws Exception {
		Transaction trx = null;
		try	{
			trx = session.beginTransaction();
			session.delete(organization);
