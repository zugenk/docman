...
public class SystemParameterHistoryServiceBase {
	private static Logger log = Logger.getLogger("com.app.docmgr.service.base.SystemParameterHistoryServiceBase");	
	// private static SystemParameterHistoryServiceBase instance = null;
	 ...
	 */
	 /*
	public static synchronized SystemParameterHistoryServiceBase getInstance(){
		if(instance == null){
			instance = new SystemParameterHistoryServiceBase();
		}
		return instance;
	}
	*/
