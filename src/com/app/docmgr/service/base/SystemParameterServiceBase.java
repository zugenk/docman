...
public class SystemParameterServiceBase {
	private static Logger log = Logger.getLogger("com.app.docmgr.service.base.SystemParameterServiceBase");	
	// private static SystemParameterServiceBase instance = null;
	 ...
	 */
	 /*
	public static synchronized SystemParameterServiceBase getInstance(){
		if(instance == null){
			instance = new SystemParameterServiceBase();
		}
		return instance;
	}
	*/
