...
public class MessageServiceBase {
	private static Logger log = Logger.getLogger("com.app.docmgr.service.base.MessageServiceBase");	
	// private static MessageServiceBase instance = null;
	 ...
	 */
	 /*
	public static synchronized MessageServiceBase getInstance(){
		if(instance == null){
			instance = new MessageServiceBase();
		}
		return instance;
	}
	*/
