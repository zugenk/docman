 ...
 */
    ...
    public void doActivateOk(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response){
       	try{
       		SystemParameterHistory systemParameterHistory = (SystemParameterHistory) request.getSession().getAttribute("systemParameterHistory");
    		if(systemParameterHistory == null){
    			response.sendRedirect("systemParameterHistory.do?action=activate_confirm");
    		}
    		systemParameterHistory.setStatus(StatusService.getInstance().getByTypeandCode("SystemParameterHistory","activated"));
			systemParameterHistory.setLastUpdatedDate(new Date());
			systemParameterHistory.setLastUpdatedBy(_doneBy);
    		SystemParameterHistoryService.getInstance().update(systemParameterHistory);
    		response.sendRedirect("systemParameterHistory.do?action=detail");    		
    ...
    public void doBlockOk(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response){
       	try{
       		SystemParameterHistory systemParameterHistory = (SystemParameterHistory) request.getSession().getAttribute("systemParameterHistory");
    		if(systemParameterHistory == null){
    			response.sendRedirect("systemParameterHistory.do?action=block_confirm");
    		}
    		systemParameterHistory.setStatus(StatusService.getInstance().getByTypeandCode("SystemParameterHistory","blocked"));
			systemParameterHistory.setLastUpdatedDate(new Date());
			systemParameterHistory.setLastUpdatedBy(_doneBy);
    		SystemParameterHistoryService.getInstance().update(systemParameterHistory);
    		response.sendRedirect("systemParameterHistory.do?action=detail");    		
