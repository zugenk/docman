 ...
 */
    ...
    public void doActivateOk(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response){
       	try{
       		EmailLog emailLog = (EmailLog) request.getSession().getAttribute("emailLog");
    		if(emailLog == null){
    			response.sendRedirect("emailLog.do?action=activate_confirm");
    		}
    		emailLog.setStatus(StatusService.getInstance().getByTypeandCode("EmailLog","activated"));
    		EmailLogService.getInstance().update(emailLog);
    		response.sendRedirect("emailLog.do?action=detail");    		
    	}catch(Exception ex){
    		try{
    ...
    public void doArchiveOk(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response){
       	try{
       		EmailLog emailLog = (EmailLog) request.getSession().getAttribute("emailLog");
    		if(emailLog == null){
    			response.sendRedirect("emailLog.do?action=archive_confirm");
    		}
    		emailLog.setStatus(StatusService.getInstance().getByTypeandCode("EmailLog","archived"));
    		EmailLogService.getInstance().update(emailLog);
    		response.sendRedirect("emailLog.do?action=detail");    		
    	}catch(Exception ex){
    		try{
    ...
    public void doBlockOk(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response){
       	try{
       		EmailLog emailLog = (EmailLog) request.getSession().getAttribute("emailLog");
    		if(emailLog == null){
    			response.sendRedirect("emailLog.do?action=block_confirm");
    		}
    		emailLog.setStatus(StatusService.getInstance().getByTypeandCode("EmailLog","blocked"));
    		EmailLogService.getInstance().update(emailLog);
    		response.sendRedirect("emailLog.do?action=detail");    		
    	}catch(Exception ex){
    		try{
