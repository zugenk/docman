	...
	<TABLE border="0" width="98%" align="center" cellpadding="0" cellspacing="0">
		...
		<tr>
			...
			<td>
				...
				<% if(com.app.docmgr.action.LookupAction.allowableAction.contains("activate")) { 
						if (privilegeList.contains("LOOKUP_ACTIVATE")) { %>
				...
				<% if(com.app.docmgr.action.LookupAction.allowableAction.contains("block")) { 
						if (privilegeList.contains("LOOKUP_BLOCK")) { %>
