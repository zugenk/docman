...
<html:html>
<HEAD>
<TITLE><bean:message key="page.Lookup.ListPopup"/></TITLE>
<!--
/**
...
<SCRIPT type="text/javascript" language="javascript">
	<!--
		...
		function doAddParent(val){
			var formName = document.forms.lookup.parentForm.value;
			var fieldName = document.forms.lookup.parentField.value;
...
<TABLE border="0" width="98%" align="center" cellpadding="3" cellspacing="1">
	<tr>
		<td class="titleHeader" colspan="17" align="left">
			<bean:message key="page.Lookup.ListPopup"/>
		</td>
	</tr>
	...
	<logic:iterate id="element" name="lookupList" scope="request" type="com.app.docmgr.model.Lookup">
		...
		<td><a href="#" onclick="doAddParent('<bean:write name="element" property="priority"/>');"><bean:write name="element" property="priority"/></a></td>
		...
		<td><a href="#" onclick="doAddParent('<bean:write name="element" property="shortname"/>');"><bean:write name="element" property="shortname"/></a></td>
		<td><a href="#" onclick="doAddParent('<bean:write name="element" property="filter"/>');"><bean:write name="element" property="filter"/></a></td>
		</tr>		
	</logic:iterate> 
</TABLE>
