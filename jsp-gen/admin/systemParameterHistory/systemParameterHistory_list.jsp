...
<% 
	...
	if(com.app.docmgr.admin.action.SystemParameterHistoryAction.allowableAction.contains("detail")) { 
		if (UserService.getInstance().hasPrivilege(loginUser,"ADMIN:SYSTEM_PARAMETER_HISTORY_DETAIL")) {
			allowDetail=true;			
		}
	}
%>
...
<TABLE border="0" width="98%" align="center" cellpadding="3" cellspacing="1">
	...
	<tr>
		<td colspan="22" align="right">
		<% if(com.app.docmgr.admin.action.SystemParameterHistoryAction.allowableAction.contains("create")) { 
				if (UserService.getInstance().hasPrivilege(loginUser,"ADMIN:SYSTEM_PARAMETER_HISTORY_CREATE")) { %>
