...
<html:html>
<HEAD>
<TITLE><bean:message key="page.Privilege.ListPopup"/></TITLE>
<!--
/**
...
<SCRIPT type="text/javascript" language="javascript">
	<!--
		...
		function doAddParent(val){
			var formName = document.forms.privilege.parentForm.value;
			var fieldName = document.forms.privilege.parentField.value;
...
<TABLE border="0" width="98%" align="center" cellpadding="3" cellspacing="1">
	<tr>
		<td class="titleHeader" colspan="13" align="left">
			<bean:message key="page.Privilege.ListPopup"/>
		</td>
	</tr>
