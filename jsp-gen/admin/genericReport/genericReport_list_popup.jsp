...
<html:html>
<HEAD>
<TITLE><bean:message key="page.GenericReport.ListPopup"/></TITLE>
<!--
/**
...
<SCRIPT type="text/javascript" language="javascript">
	<!--
		...
		function doAddParent(val){
			var formName = document.forms.genericReport.parentForm.value;
			var fieldName = document.forms.genericReport.parentField.value;
...
<TABLE border="0" width="98%" align="center" cellpadding="3" cellspacing="1">
	<tr>
		<td class="titleHeader" colspan="16" align="left">
			<bean:message key="page.GenericReport.ListPopup"/>
		</td>
	</tr>
	...
	<logic:iterate id="element" name="genericReportList" scope="request" type="com.app.docmgr.model.GenericReport">
		...
		<td><a href="#" onclick="doAddParent('<bean:write name="element" property="reportFields"/>');"><bean:write name="element" property="reportFields"/></a></td>
		<td><a href="#" onclick="doAddParent('<bean:write name="element" property="searchFields"/>');"><bean:write name="element" property="searchFields"/></a></td>
		<td><a href="#" onclick="doAddParent('<bean:write name="element" property="reportSql"/>');"><bean:write name="element" property="reportSql"/></a></td>
		...
		<td><a href="#" onclick="doAddParent('<bean:write name="element" property="columnAction"/>');"><bean:write name="element" property="columnAction"/></a></td>
		</tr>		
	</logic:iterate> 
</TABLE>
