...
<html:html>
<HEAD>
<TITLE><bean:message key="page.Status.ListPopup"/></TITLE>
<!--
/**
...
<SCRIPT type="text/javascript" language="javascript">
	<!--
		...
		function doAddParent(val){
			var formName = document.forms.status.parentForm.value;
			var fieldName = document.forms.status.parentField.value;
...
<TABLE border="0" width="98%" align="center" cellpadding="3" cellspacing="1">
	<tr>
		<td class="titleHeader" colspan="15" align="left">
			<bean:message key="page.Status.ListPopup"/>
		</td>
	</tr>
	...
	<logic:iterate id="element" name="statusList" scope="request" type="com.app.docmgr.model.Status">
		...
		<td><a href="#" onclick="doAddParent('<bean:write name="element" property="state"/>');"><bean:write name="element" property="state"/></a></td>
