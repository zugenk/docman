...
<% 
	...
	if(com.app.docmgr.admin.action.OrganizationAction.allowableAction.contains("detail")) { 
		if (UserService.getInstance().hasPrivilege(loginUser,"ADMIN:ORGANIZATION_DETAIL")) {
			allowDetail=true;			
		}
	}
%>
...
<TABLE border="0" width="98%" align="center" cellpadding="3" cellspacing="1">
	...
	<tr>
		<td colspan="20" align="right">
		<% if(com.app.docmgr.admin.action.OrganizationAction.allowableAction.contains("create")) { 
				if (UserService.getInstance().hasPrivilege(loginUser,"ADMIN:ORGANIZATION_CREATE")) { %>
