...
%>
<HEAD>
<TITLE><bean:message key="page.Organization.CreateConfirm"/></TITLE>
<!--
/**
...
<form name="organization" action="organization.do" method="POST">
	...
	<TABLE border="0" width="98%" align="center" cellpadding="0" cellspacing="0">
		...
		<tr>
			<td colspan="3" class="titleHeader">
				<bean:message key="page.Organization.CreateConfirm"/>
			</td>
		</tr>
		<tr>
 ...
 <% /* %> 		<tr>
			...
			<td width="10">:</td>
			<td><bean:write name="organization" property="createdDate" format="dd/MM/yyyy"/></td>
		</tr>
 <% */ %>  <% /* %> 		<tr>
 ...
 <% */ %>  <% /* %> 		<tr>
			...
			<td width="10">:</td>
			<td><bean:write name="organization" property="lastUpdatedDate" format="dd/MM/yyyy"/></td>
		</tr>
 <% */ %>  <% /* %> 		<tr>
