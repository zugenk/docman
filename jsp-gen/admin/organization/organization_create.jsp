...
%>
<HEAD>
<TITLE><bean:message key="page.Organization.Create"/></TITLE>
<!--
/**
...
<form name="organization" action="organization.do" method="POST" enctype="multipart/form-data" onsubmit="markAll()">
	...
	<table border="0" align="center" width="98%" cellpadding="0" cellspacing="0">
		...
		<tr>
			<td class="titleHeader" colspan="3" align="left">
				<bean:message key="page.Organization.Create"/>
			</td>
		</tr>
		<tr>
			<td class="titleHeader" colspan="3" align="left">
 ...
 <% /* %> 		<tr>
			...
			<td width="10">:</td>			
			<td><input type="text" name="createdDate" onclick="calendarToogle('createdDate', 'createdDate_cal', null);"  onKeyDown="drawCalendar('createdDate', 'createdDate_cal', null);" value="<bean:write name='organization' property='createdDate' format='dd/MM/yyyy' />"/></td>
		</tr>
		<tr>
			<td colspan="2" />
 ...
 <% */ %>  <% /* %> 		<tr>
			...
			<td width="10">:</td>			
			<td><input type="text" name="lastUpdatedDate" onclick="calendarToogle('lastUpdatedDate', 'lastUpdatedDate_cal', null);"  onKeyDown="drawCalendar('lastUpdatedDate', 'lastUpdatedDate_cal', null);" value="<bean:write name='organization' property='lastUpdatedDate' format='dd/MM/yyyy' />"/></td>
		</tr>
		<tr>
			<td colspan="2" />
...
<!-- set one to many start -->
 ...
 <% */ %> 			<td><b><bean:message key="user.organization.key"/></b></td>
	...
	<logic:iterate id="element_user" name="userSet" type="com.app.docmgr.model.User">
		...
		<tr>
			<td>
				<bean:write name="element_user" property="loginName"/>
			</td>
			<td>
				<bean:write name="element_user" property="loginPassword"/>
			</td>
			<td>
				<bean:write name="element_user" property="pinCode"/>
			</td>
			<td>
			...
			<td>
				<bean:write name="element_user" property="title"/>
			</td>
			<td>
			...
			<td>
				<bean:write name="element_user" property="fullName"/>
			</td>
			<td>
				<bean:write name="element_user" property="homePhoneNumber"/>
			</td>
			<td>
				<bean:write name="element_user" property="mobilePhoneNumber"/>
			</td>
			<td>
				<bean:write name="element_user" property="employeeNumber"/>
			</td>
 <% /* %> 			<td>
				<bean:write name="element_user" property="createdDate"/>
			</td>
 <% */ %>  <% /* %> 			<td>
				<bean:write name="element_user" property="createdBy"/>
			</td>
 <% */ %>  <% /* %> 			<td>
				<bean:write name="element_user" property="lastUpdatedDate"/>
			</td>
 <% */ %>  <% /* %> 			<td>
				<bean:write name="element_user" property="lastUpdatedBy"/>
			</td>
 <% */ %> 			<td>
				<bean:write name="element_user" property="firstLogin"/>
			</td>
			<td>
				<bean:write name="element_user" property="lastPasswordUpdate"/>
			</td>
			<td>
				<bean:write name="element_user" property="lastPinCodeUpdate"/>
			</td>
			<td>
				<bean:write name="element_user" property="lastPassword"/>
			</td>
			<td>
				<bean:write name="element_user" property="lastPinCode"/>
			</td>
			<td>
				<bean:write name="element_user" property="loginFailed"/>
			</td>
			<td>
				<bean:write name="element_user" property="maxRelease"/>
			</td>
			<td>
				<bean:write name="element_user" property="lastReleasedDate"/>
			</td>
			<td>
				<bean:write name="element_user" property="lastActive"/>
			</td>
			<td>
				<bean:write name="element_user" property="sessionCode"/>
			</td>
			<td>
				<bean:write name="element_user" property="IPassport"/>
			</td>
			<td>
 ...
 <% */ %> 				<logic:messagesPresent property="user.lastUpdatedDate">
  ...
  <% /* %> 			<td>
				<html-el:select  name="element_user" property="status" style="width:135"  value="${user.status.id}">
					<option value=""></option>
					<html:options collection="statusList_user" property="id" labelProperty="name"/>
				</html-el:select>																		
			</td>
  <% */ %> 			<td>
