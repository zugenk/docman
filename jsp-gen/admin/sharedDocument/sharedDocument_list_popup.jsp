...
<html:html>
<HEAD>
<TITLE><bean:message key="page.SharedDocument.ListPopup"/></TITLE>
<!--
/**
...
<SCRIPT type="text/javascript" language="javascript">
	<!--
		...
		function doAddParent(val){
			var formName = document.forms.sharedDocument.parentForm.value;
			var fieldName = document.forms.sharedDocument.parentField.value;
...
<TABLE border="0" width="98%" align="center" cellpadding="3" cellspacing="1">
	<tr>
		<td class="titleHeader" colspan="13" align="left">
			<bean:message key="page.SharedDocument.ListPopup"/>
		</td>
	</tr>
	...
	<logic:iterate id="element" name="sharedDocumentList" scope="request" type="com.app.docmgr.model.SharedDocument">
		...
		<td><a href="#" onclick="doAddParent('<bean:write name="element" property="grantAction"/>');"><bean:write name="element" property="grantAction"/></a></td>
