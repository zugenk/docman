	...
	<TABLE border="0" width="98%" align="center" cellpadding="0" cellspacing="0">
		...
		<tr>
			...
			<td>
				...
				<% if(com.app.docmgr.admin.action.SystemParameterAction.allowableAction.contains("activate")) { 
						if (com.app.docmgr.service.UserService.getInstance().hasPrivilege(loginUser,"ADMIN:SYSTEM_PARAMETER_ACTIVATE")) { %>
				...
				<% if(com.app.docmgr.admin.action.SystemParameterAction.allowableAction.contains("archive")) { 
						if (com.app.docmgr.service.UserService.getInstance().hasPrivilege(loginUser,"ADMIN:SYSTEM_PARAMETER_ARCHIVE")) { %>
				...
				<% if(com.app.docmgr.admin.action.SystemParameterAction.allowableAction.contains("block")) { 
						if (com.app.docmgr.service.UserService.getInstance().hasPrivilege(loginUser,"ADMIN:SYSTEM_PARAMETER_BLOCK")) { %>
