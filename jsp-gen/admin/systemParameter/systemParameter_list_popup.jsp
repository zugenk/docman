...
<html:html>
<HEAD>
<TITLE><bean:message key="page.SystemParameter.ListPopup"/></TITLE>
<!--
/**
...
<SCRIPT type="text/javascript" language="javascript">
	<!--
		...
		function doAddParent(val){
			var formName = document.forms.systemParameter.parentForm.value;
			var fieldName = document.forms.systemParameter.parentField.value;
...
<TABLE border="0" width="98%" align="center" cellpadding="3" cellspacing="1">
	<tr>
		<td class="titleHeader" colspan="18" align="left">
			<bean:message key="page.SystemParameter.ListPopup"/>
		</td>
	</tr>
