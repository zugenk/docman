...
%>
<HEAD>
<TITLE><bean:message key="page.Announcement.Edit"/></TITLE>
<!--
/**
...
<form name="announcement" action="announcement.do" method="POST" enctype="multipart/form-data" onsubmit="markAll()">
	...
	<html:hidden name="announcement" property="id"/>
	...
	<table border="0" align="center" width="98%" cellpadding="0" cellspacing="0">
		...
		<tr>
			<td class="titleHeader" colspan="3" align="left">
				<bean:message key="page.Announcement.Edit"/>
			</td>
		</tr>
		...
		<tr>
			...
			<td width="10">:</td>
			<td>
				<html:text name="announcement" property="subject"/>
			</td>
		</tr>
		<tr>
  ...
  <% /* %> 		<tr>
			...
			<td width="10">:</td>
			<td>
				<input type="text" name="createdDate" onclick="calendarToogle('createdDate', 'createdDate_cal', null);"  onKeyDown="drawCalendar('createdDate', 'createdDate_cal', null);" value="<bean:write name="announcement" property="createdDate" format="dd/MM/yyyy" />"/>
			</td>
		</tr>
		<tr>
			<td colspan="2" />
  ...
  <% */ %>   <% /* %> 		<tr>
			...
			<td width="10">:</td>
			<td>
				<input type="text" name="lastUpdatedDate" onclick="calendarToogle('lastUpdatedDate', 'lastUpdatedDate_cal', null);"  onKeyDown="drawCalendar('lastUpdatedDate', 'lastUpdatedDate_cal', null);" value="<bean:write name="announcement" property="lastUpdatedDate" format="dd/MM/yyyy" />"/>
			</td>
		</tr>
		<tr>
			<td colspan="2" />
