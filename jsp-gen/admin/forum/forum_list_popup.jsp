...
<html:html>
<HEAD>
<TITLE><bean:message key="page.Forum.ListPopup"/></TITLE>
<!--
/**
...
<SCRIPT type="text/javascript" language="javascript">
	<!--
		...
		function doAddParent(val){
			var formName = document.forms.forum.parentForm.value;
			var fieldName = document.forms.forum.parentField.value;
...
<TABLE border="0" width="98%" align="center" cellpadding="3" cellspacing="1">
	<tr>
		<td class="titleHeader" colspan="19" align="left">
			<bean:message key="page.Forum.ListPopup"/>
		</td>
	</tr>
