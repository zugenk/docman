...
%>
<HEAD>
<TITLE><bean:message key="page.Topic.ActivateConfirm"/></TITLE>
<!--
/**
	...
	<TABLE border="0" width="98%" align="center" cellpadding="0" cellspacing="0">
		...
		<tr>
			<td class="titleHeader" colspan="3" >
				<bean:message key="page.Topic.ActivateConfirm"/>
			</td>
		</tr>
		<tr>
			<td colspan="3" align="right">
		...
		<tr>
			<td width="150"><bean:message key="topic.numberOfLike.key"/></td>
			<td width="10">:</td>
			<td><bean:write name="topic" property="numberOfLike"/></td>
		</tr>
		<tr>
			<td width="150"><bean:message key="topic.numberOfPost.key"/></td>
			<td width="10">:</td>
			<td><bean:write name="topic" property="numberOfPost"/></td>
		</tr>
		<tr>
			<td width="150"><bean:message key="topic.createdDate.key"/></td>
			<td width="10">:</td>
		...
		<tr>
			<td width="150"><bean:message key="topic.lastUpdatedDate.key"/></td>
			<td width="10">:</td>
