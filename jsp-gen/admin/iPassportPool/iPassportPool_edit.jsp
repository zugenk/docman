...
%>
<HEAD>
<TITLE><bean:message key="page.IPassportPool.Edit"/></TITLE>
<!--
/**
...
<form name="iPassportPool" action="iPassportPool.do" method="POST" enctype="multipart/form-data" onsubmit="markAll()">
	...
	<html:hidden name="iPassportPool" property="id"/>
	...
	<table border="0" align="center" width="98%" cellpadding="0" cellspacing="0">
		...
		<tr>
			<td class="titleHeader" colspan="3" align="left">
				<bean:message key="page.IPassportPool.Edit"/>
			</td>
		</tr>
		...
		<tr>
			...
			<td width="10">:</td>
			<td>
				<input type="text" name="lastLogin" onclick="calendarToogle('lastLogin', 'lastLogin_cal', null);"  onKeyDown="drawCalendar('lastLogin', 'lastLogin_cal', null);" value="<bean:write name="iPassportPool" property="lastLogin" format="dd/MM/yyyy" />"/>
			</td>
		</tr>
		<tr>
			<td colspan="2" />
			<td>
				<div id="lastLogin_cal" style="display: none"></div>
			</td>
		</tr>
		<tr>
			...
			<td width="10">:</td>
			<td>
				<input type="text" name="lastActive" onclick="calendarToogle('lastActive', 'lastActive_cal', null);"  onKeyDown="drawCalendar('lastActive', 'lastActive_cal', null);" value="<bean:write name="iPassportPool" property="lastActive" format="dd/MM/yyyy" />"/>
			</td>
		</tr>
		<tr>
			<td colspan="2" />
