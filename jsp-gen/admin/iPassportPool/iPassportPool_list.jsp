...
<% 
	...
	if(com.app.docmgr.admin.action.IPassportPoolAction.allowableAction.contains("detail")) { 
		if (UserService.getInstance().hasPrivilege(loginUser,"ADMIN:I_PASSPORT_POOL_DETAIL")) {
			allowDetail=true;			
		}
	}
%>
...
<TABLE border="0" width="98%" align="center" cellpadding="3" cellspacing="1">
	...
	<tr>
		<td colspan="14" align="right">
		<% if(com.app.docmgr.admin.action.IPassportPoolAction.allowableAction.contains("create")) { 
				if (UserService.getInstance().hasPrivilege(loginUser,"ADMIN:I_PASSPORT_POOL_CREATE")) { %>
