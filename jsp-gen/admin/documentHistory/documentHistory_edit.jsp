...
%>
<HEAD>
<TITLE><bean:message key="page.DocumentHistory.Edit"/></TITLE>
<!--
/**
...
<form name="documentHistory" action="documentHistory.do" method="POST" enctype="multipart/form-data" onsubmit="markAll()">
	...
	<html:hidden name="documentHistory" property="id"/>
	...
	<table border="0" align="center" width="98%" cellpadding="0" cellspacing="0">
		...
		<tr>
			<td class="titleHeader" colspan="3" align="left">
				<bean:message key="page.DocumentHistory.Edit"/>
			</td>
		</tr>
		...
		<tr>
			...
			<td width="10">:</td>
			<td>
				<input type="text" name="historyDate" onclick="calendarToogle('historyDate', 'historyDate_cal', null);"  onKeyDown="drawCalendar('historyDate', 'historyDate_cal', null);" value="<bean:write name="documentHistory" property="historyDate" format="dd/MM/yyyy" />"/>
			</td>
		</tr>
		<tr>
			<td colspan="2" />
		...
		<tr>
			...
			<td width="10">:</td>
			<td>
				<html:text name="documentHistory" property="tag"/>
			</td>
		</tr>
  <% /* %> 		<tr>
			...
			<td width="10">:</td>
			<td>
				<input type="text" name="createdDate" onclick="calendarToogle('createdDate', 'createdDate_cal', null);"  onKeyDown="drawCalendar('createdDate', 'createdDate_cal', null);" value="<bean:write name="documentHistory" property="createdDate" format="dd/MM/yyyy" />"/>
			</td>
		</tr>
		<tr>
			<td colspan="2" />
  ...
  <% */ %>   <% /* %> 		<tr>
			...
			<td width="10">:</td>
			<td>
				<input type="text" name="lastUpdatedDate" onclick="calendarToogle('lastUpdatedDate', 'lastUpdatedDate_cal', null);"  onKeyDown="drawCalendar('lastUpdatedDate', 'lastUpdatedDate_cal', null);" value="<bean:write name="documentHistory" property="lastUpdatedDate" format="dd/MM/yyyy" />"/>
			</td>
		</tr>
		<tr>
			<td colspan="2" />
  ...
  <% */ %> 		<tr>
			<td width="150"><b><bean:message key="documentHistory.folder.key"/> <font color="#FF0000">*</font></b></td>
			<td width="10">:</td>
			<td>				
				<html-el:select  name="documentHistory" property="folder" style="width:135"  value="${documentHistory.folder.id}">
					<option value=""></option>
					<html:options collection="folderList" property="id" labelProperty="name"/>
				</html-el:select>															
			</td>
		</tr>
		<logic:messagesPresent property="documentHistory.folder">
			<tr>
				<td colspan="3">
					<font color="red"><html:errors property="documentHistory.folder"/></font>
				</td>
			</tr>
		</logic:messagesPresent>
		<tr>
			...
			<td width="10">:</td>
			<td>				
				<html-el:select  name="documentHistory" property="parent" style="width:135"  value="${documentHistory.parent.id}">
					<option value=""></option>
