...
<% 
	...
	if(com.app.docmgr.admin.action.DocumentHistoryAction.allowableAction.contains("detail")) { 
		if (UserService.getInstance().hasPrivilege(loginUser,"ADMIN:DOCUMENT_HISTORY_DETAIL")) {
			allowDetail=true;			
		}
	}
%>
