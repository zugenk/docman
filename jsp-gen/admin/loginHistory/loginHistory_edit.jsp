...
%>
<HEAD>
<TITLE><bean:message key="page.LoginHistory.Edit"/></TITLE>
<!--
/**
...
<form name="loginHistory" action="loginHistory.do" method="POST" enctype="multipart/form-data" onsubmit="markAll()">
	...
	<html:hidden name="loginHistory" property="id"/>
	...
	<table border="0" align="center" width="98%" cellpadding="0" cellspacing="0">
		...
		<tr>
			<td class="titleHeader" colspan="3" align="left">
				<bean:message key="page.LoginHistory.Edit"/>
			</td>
		</tr>
		...
		<tr>
			...
			<td width="10">:</td>
			<td>
				<input type="text" name="loginTime" onclick="calendarToogle('loginTime', 'loginTime_cal', null);"  onKeyDown="drawCalendar('loginTime', 'loginTime_cal', null);" value="<bean:write name="loginHistory" property="loginTime" format="dd/MM/yyyy" />"/>
			</td>
		</tr>
		<tr>
			<td colspan="2" />
			<td>
				<div id="loginTime_cal" style="display: none"></div>
			</td>
		</tr>
		...
		<tr>
			...
			<td width="10">:</td>
			<td>
				<input type="text" name="lastAccess" onclick="calendarToogle('lastAccess', 'lastAccess_cal', null);"  onKeyDown="drawCalendar('lastAccess', 'lastAccess_cal', null);" value="<bean:write name="loginHistory" property="lastAccess" format="dd/MM/yyyy" />"/>
			</td>
		</tr>
		<tr>
			<td colspan="2" />
			<td>
				<div id="lastAccess_cal" style="display: none"></div>
			</td>
		</tr>
		...
		<tr>
			...
			<td width="10">:</td>
			<td>
				<input type="text" name="logoutTime" onclick="calendarToogle('logoutTime', 'logoutTime_cal', null);"  onKeyDown="drawCalendar('logoutTime', 'logoutTime_cal', null);" value="<bean:write name="loginHistory" property="logoutTime" format="dd/MM/yyyy" />"/>
			</td>
		</tr>
		<tr>
			<td colspan="2" />
			<td>
				<div id="logoutTime_cal" style="display: none"></div>
			</td>
		</tr>
		<tr>
