...
<html:html>
<HEAD>
<TITLE><bean:message key="page.Role.ListPopup"/></TITLE>
<!--
/**
...
<SCRIPT type="text/javascript" language="javascript">
	<!--
		...
		function doAddParent(val){
			var formName = document.forms.role.parentForm.value;
			var fieldName = document.forms.role.parentField.value;
...
<TABLE border="0" width="98%" align="center" cellpadding="3" cellspacing="1">
	<tr>
		<td class="titleHeader" colspan="16" align="left">
			<bean:message key="page.Role.ListPopup"/>
		</td>
	</tr>
