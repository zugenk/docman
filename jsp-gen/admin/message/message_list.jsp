...
<% 
	...
	if(com.app.docmgr.admin.action.MessageAction.allowableAction.contains("detail")) { 
		if (UserService.getInstance().hasPrivilege(loginUser,"ADMIN:MESSAGE_DETAIL")) {
			allowDetail=true;			
		}
	}
%>
...
<TABLE border="0" width="98%" align="center" cellpadding="3" cellspacing="1">
	...
	<tr>
		<td colspan="16" align="right">
		<% if(com.app.docmgr.admin.action.MessageAction.allowableAction.contains("create")) { 
				if (UserService.getInstance().hasPrivilege(loginUser,"ADMIN:MESSAGE_CREATE")) { %>
