	...
	<TABLE border="0" width="98%" align="center" cellpadding="0" cellspacing="0">
		...
		<tr>
			...
			<td>
				...
				<% if(com.app.docmgr.action.UserHistoryAction.allowableAction.contains("activate")) { 
						if (privilegeList.contains("USER_HISTORY_ACTIVATE")) { %>
				...
				<% if(com.app.docmgr.action.UserHistoryAction.allowableAction.contains("archive")) { 
						if (privilegeList.contains("USER_HISTORY_ARCHIVE")) { %>
				...
				<% if(com.app.docmgr.action.UserHistoryAction.allowableAction.contains("block")) { 
						if (privilegeList.contains("USER_HISTORY_BLOCK")) { %>
