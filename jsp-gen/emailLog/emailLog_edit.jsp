...
%>
<HEAD>
<TITLE><bean:message key="page.EmailLog.Edit"/></TITLE>
<!--
/**
...
<form name="emailLog" action="emailLog.do" method="POST" enctype="multipart/form-data" onsubmit="markAll()">
	...
	<html:hidden name="emailLog" property="id"/>
	...
	<table border="0" align="center" width="98%" cellpadding="0" cellspacing="0">
		...
		<tr>
			<td class="titleHeader" colspan="3" align="left">
				<bean:message key="page.EmailLog.Edit"/>
			</td>
		</tr>
		...
		<tr>
			...
			<td width="10">:</td>
			<td>
				<input type="text" name="dueDate" onclick="calendarToogle('dueDate', 'dueDate_cal', null);"  onKeyDown="drawCalendar('dueDate', 'dueDate_cal', null);" value="<bean:write name="emailLog" property="dueDate" format="dd/MM/yyyy" />"/>
			</td>
		</tr>
		<tr>
			<td colspan="2" />
			<td>
				<div id="dueDate_cal" style="display: none"></div>
			</td>
		</tr>
		...
		<tr>
			...
			<td width="10">:</td>
			<td>
				<input type="text" name="sentDate" onclick="calendarToogle('sentDate', 'sentDate_cal', null);"  onKeyDown="drawCalendar('sentDate', 'sentDate_cal', null);" value="<bean:write name="emailLog" property="sentDate" format="dd/MM/yyyy" />"/>
			</td>
		</tr>
		<tr>
			<td colspan="2" />
			<td>
				<div id="sentDate_cal" style="display: none"></div>
			</td>
		</tr>
		<tr>
			...
			<td width="10">:</td>
			<td>
				<input type="text" name="lastTrialDate" onclick="calendarToogle('lastTrialDate', 'lastTrialDate_cal', null);"  onKeyDown="drawCalendar('lastTrialDate', 'lastTrialDate_cal', null);" value="<bean:write name="emailLog" property="lastTrialDate" format="dd/MM/yyyy" />"/>
			</td>
		</tr>
		<tr>
			<td colspan="2" />
			<td>
				<div id="lastTrialDate_cal" style="display: none"></div>
			</td>
		</tr>
