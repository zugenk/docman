...
<% 
	...
	if(com.app.docmgr.action.EmailLogAction.allowableAction.contains("detail")) { 
		if (privilegeList.contains("EMAIL_LOG_DETAIL")) {
			allowDetail=true;			
		}
	}
%>
...
<TABLE border="0" width="98%" align="center" cellpadding="3" cellspacing="1">
	...
	<tr>
		<td colspan="19" align="right">
		<% if(com.app.docmgr.action.EmailLogAction.allowableAction.contains("create")) { 
				if (privilegeList.contains("EMAIL_LOG_CREATE")) { %>
