	...
	<TABLE border="0" width="98%" align="center" cellpadding="0" cellspacing="0">
		...
		<tr>
			...
			<td>
				...
				<% if(com.app.docmgr.action.LoginHistoryAction.allowableAction.contains("activate")) { 
						if (privilegeList.contains("LOGIN_HISTORY_ACTIVATE")) { %>
				...
				<% if(com.app.docmgr.action.LoginHistoryAction.allowableAction.contains("archive")) { 
						if (privilegeList.contains("LOGIN_HISTORY_ARCHIVE")) { %>
				...
				<% if(com.app.docmgr.action.LoginHistoryAction.allowableAction.contains("block")) { 
						if (privilegeList.contains("LOGIN_HISTORY_BLOCK")) { %>
