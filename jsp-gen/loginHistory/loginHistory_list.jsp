...
<% 
	...
	if(com.app.docmgr.action.LoginHistoryAction.allowableAction.contains("detail")) { 
		if (privilegeList.contains("LOGIN_HISTORY_DETAIL")) {
			allowDetail=true;			
		}
	}
%>
...
<TABLE border="0" width="98%" align="center" cellpadding="3" cellspacing="1">
	...
	<tr>
		<td colspan="15" align="right">
		<% if(com.app.docmgr.action.LoginHistoryAction.allowableAction.contains("create")) { 
				if (privilegeList.contains("LOGIN_HISTORY_CREATE")) { %>
