	...
	<TABLE border="0" width="98%" align="center" cellpadding="0" cellspacing="0">
		...
		<tr>
			...
			<td>
				...
				<% if(com.app.docmgr.action.BookmarkAction.allowableAction.contains("activate")) { 
						if (privilegeList.contains("BOOKMARK_ACTIVATE")) { %>
				...
				<% if(com.app.docmgr.action.BookmarkAction.allowableAction.contains("block")) { 
						if (privilegeList.contains("BOOKMARK_BLOCK")) { %>
