...
%>
<HEAD>
<TITLE><bean:message key="page.Bookmark.ActivateConfirm"/></TITLE>
<!--
/**
	...
	<TABLE border="0" width="98%" align="center" cellpadding="0" cellspacing="0">
		...
		<tr>
			<td class="titleHeader" colspan="3" >
				<bean:message key="page.Bookmark.ActivateConfirm"/>
			</td>
		</tr>
		<tr>
			<td colspan="3" align="right">
		...
		<tr>
			<td width="150"><bean:message key="bookmark.lastUpdatedDate.key"/></td>
			<td width="10">:</td>
