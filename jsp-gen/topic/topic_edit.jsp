...
%>
<HEAD>
<TITLE><bean:message key="page.Topic.Edit"/></TITLE>
<!--
/**
...
<form name="topic" action="topic.do" method="POST" enctype="multipart/form-data" onsubmit="markAll()">
	...
	<html:hidden name="topic" property="id"/>
	...
	<table border="0" align="center" width="98%" cellpadding="0" cellspacing="0">
		...
		<tr>
			<td class="titleHeader" colspan="3" align="left">
				<bean:message key="page.Topic.Edit"/>
			</td>
		</tr>
  ...
  <% /* %> 		<tr>
			...
			<td width="10">:</td>
			<td>
				<input type="text" name="createdDate" onclick="calendarToogle('createdDate', 'createdDate_cal', null);"  onKeyDown="drawCalendar('createdDate', 'createdDate_cal', null);" value="<bean:write name="topic" property="createdDate" format="dd/MM/yyyy" />"/>
			</td>
		</tr>
		<tr>
			<td colspan="2" />
  ...
  <% */ %>   <% /* %> 		<tr>
			...
			<td width="10">:</td>
			<td>
				<input type="text" name="lastUpdatedDate" onclick="calendarToogle('lastUpdatedDate', 'lastUpdatedDate_cal', null);"  onKeyDown="drawCalendar('lastUpdatedDate', 'lastUpdatedDate_cal', null);" value="<bean:write name="topic" property="lastUpdatedDate" format="dd/MM/yyyy" />"/>
			</td>
		</tr>
		<tr>
			<td colspan="2" />
  ...
  <% /* %> 		<tr>
			<td width="150"><b><bean:message key="topic.status.key"/> <font color="#FF0000">*</font></b></td>
			<td width="10">:</td>
			<td>				
				<html-el:select  name="topic" property="status" style="width:135"  value="${topic.status.id}">
					<option value=""></option>
					<html:options collection="statusList" property="id" labelProperty="name"/>
				</html-el:select>															
			</td>
		</tr>
		<logic:messagesPresent property="topic.status">
			<tr>
				<td colspan="3">
					<font color="red"><html:errors property="topic.status"/></font>
				</td>
			</tr>
		</logic:messagesPresent>
  <% */ %> 		<tr>
	...
	<table border="0" width="98%" align="center">	
		<tr class="title">
			<td colspan="2"><bean:message key="topic.subscribers.key"/></td>
		</tr>
		<tr>
