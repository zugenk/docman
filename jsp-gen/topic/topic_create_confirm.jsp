...
%>
<HEAD>
<TITLE><bean:message key="page.Topic.CreateConfirm"/></TITLE>
<!--
/**
...
<form name="topic" action="topic.do" method="POST">
	...
	<TABLE border="0" width="98%" align="center" cellpadding="0" cellspacing="0">
		...
		<tr>
			<td colspan="3" class="titleHeader">
				<bean:message key="page.Topic.CreateConfirm"/>
			</td>
		</tr>
		<tr>
 ...
 <% /* %> 		<tr>
			...
			<td width="10">:</td>
			<td><bean:write name="topic" property="createdDate" format="dd/MM/yyyy"/></td>
		</tr>
 <% */ %>  <% /* %> 		<tr>
 ...
 <% */ %>  <% /* %> 		<tr>
			...
			<td width="10">:</td>
			<td><bean:write name="topic" property="lastUpdatedDate" format="dd/MM/yyyy"/></td>
		</tr>
 <% */ %>  <% /* %> 		<tr>
