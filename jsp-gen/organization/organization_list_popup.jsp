...
<html:html>
<HEAD>
<TITLE><bean:message key="page.Organization.ListPopup"/></TITLE>
<!--
/**
...
<SCRIPT type="text/javascript" language="javascript">
	<!--
		...
		function doAddParent(val){
			var formName = document.forms.organization.parentForm.value;
			var fieldName = document.forms.organization.parentField.value;
