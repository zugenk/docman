...
<form name="organization" action="organization.do" method="POST">
	...
	<TABLE border="0" width="98%" align="center" cellpadding="0" cellspacing="0">
		...
		<tr>
			...
			<td>
				<% 
				if(com.app.docmgr.action.OrganizationAction.allowableAction.contains("edit")) { 
						if (privilegeList.contains("ORGANIZATION_EDIT")) { %>

					<input type="submit" value="<bean:message key="button.edit"/>" onclick="this.form.action.value='edit'" />
					&nbsp;
				<% 		}
					} %>
				<% if(com.app.docmgr.action.OrganizationAction.allowableAction.contains("delete")) { 
						if (privilegeList.contains("ORGANIZATION_DELETE")) { %>
				...
				<% if(com.app.docmgr.action.OrganizationAction.allowableAction.contains("activate")) { 
						if (privilegeList.contains("ORGANIZATION_ACTIVATE")) { %>
				...
				<% if(com.app.docmgr.action.OrganizationAction.allowableAction.contains("block")) { 
						if (privilegeList.contains("ORGANIZATION_BLOCK")) { %>
