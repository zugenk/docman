...
<% 
	...
	if(com.app.docmgr.action.AuditTrailAction.allowableAction.contains("detail")) { 
		if (privilegeList.contains("AUDIT_TRAIL_DETAIL")) {
			allowDetail=true;			
		}
	}
%>
...
<TABLE border="0" width="98%" align="center" cellpadding="3" cellspacing="1">
	...
	<tr>
		<td colspan="17" align="right">
		<% if(com.app.docmgr.action.AuditTrailAction.allowableAction.contains("create")) { 
				if (privilegeList.contains("AUDIT_TRAIL_CREATE")) { %>
