	...
	<TABLE border="0" width="98%" align="center" cellpadding="0" cellspacing="0">
		...
		<tr>
			...
			<td>
				...
				<% if(com.app.docmgr.action.MessageAction.allowableAction.contains("activate")) { 
						if (privilegeList.contains("MESSAGE_ACTIVATE")) { %>
				...
				<% if(com.app.docmgr.action.MessageAction.allowableAction.contains("block")) { 
						if (privilegeList.contains("MESSAGE_BLOCK")) { %>
