...
<html:html>
<HEAD>
<TITLE><bean:message key="page.User.ListPopup"/></TITLE>
<!--
/**
...
<SCRIPT type="text/javascript" language="javascript">
	<!--
		...
		function doAddParent(val){
			var formName = document.forms.user.parentForm.value;
			var fieldName = document.forms.user.parentField.value;
...
<TABLE border="0" width="98%" align="center" cellpadding="3" cellspacing="1">
	<tr>
		<td class="titleHeader" colspan="37" align="left">
			<bean:message key="page.User.ListPopup"/>
		</td>
	</tr>
