...
<% 
	...
	if(com.app.docmgr.action.SystemParameterAction.allowableAction.contains("detail")) { 
		if (privilegeList.contains("SYSTEM_PARAMETER_DETAIL")) {
			allowDetail=true;			
		}
	}
%>
...
<TABLE border="0" width="98%" align="center" cellpadding="3" cellspacing="1">
	...
	<tr>
		<td colspan="18" align="right">
		<% if(com.app.docmgr.action.SystemParameterAction.allowableAction.contains("create")) { 
				if (privilegeList.contains("SYSTEM_PARAMETER_CREATE")) { %>
