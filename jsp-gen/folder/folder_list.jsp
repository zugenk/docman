...
<% 
	...
	if(com.app.docmgr.action.FolderAction.allowableAction.contains("detail")) { 
		if (privilegeList.contains("FOLDER_DETAIL")) {
			allowDetail=true;			
		}
	}
%>
...
<TABLE border="0" width="98%" align="center" cellpadding="3" cellspacing="1">
	...
	<tr>
		<td colspan="16" align="right">
		<% if(com.app.docmgr.action.FolderAction.allowableAction.contains("create")) { 
				if (privilegeList.contains("FOLDER_CREATE")) { %>
