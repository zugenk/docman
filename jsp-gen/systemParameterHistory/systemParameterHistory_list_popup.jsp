...
<html:html>
<HEAD>
<TITLE><bean:message key="page.SystemParameterHistory.ListPopup"/></TITLE>
<!--
/**
...
<SCRIPT type="text/javascript" language="javascript">
	<!--
		...
		function doAddParent(val){
			var formName = document.forms.systemParameterHistory.parentForm.value;
			var fieldName = document.forms.systemParameterHistory.parentField.value;
...
<TABLE border="0" width="98%" align="center" cellpadding="3" cellspacing="1">
	<tr>
		<td class="titleHeader" colspan="22" align="left">
			<bean:message key="page.SystemParameterHistory.ListPopup"/>
		</td>
	</tr>
	...
	<logic:iterate id="element" name="systemParameterHistoryList" scope="request" type="com.app.docmgr.model.SystemParameterHistory">
		...
		<td><a href="#" onclick="doAddParent('<bean:write name="element" property="systemParameterId"/>');"><bean:write name="element" property="systemParameterId"/></a></td>
		<td><a href="#" onclick="doAddParent('<bean:write name="element" property="vgroup"/>');"><bean:write name="element" property="vgroup"/></a></td>
		<td><a href="#" onclick="doAddParent('<bean:write name="element" property="parameter"/>');"><bean:write name="element" property="parameter"/></a></td>
		<td><a href="#" onclick="doAddParent('<bean:write name="element" property="svalue"/>');"><bean:write name="element" property="svalue"/></a></td>
