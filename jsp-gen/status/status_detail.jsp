...
<form name="status" action="status.do" method="POST">
	...
	<TABLE border="0" width="98%" align="center" cellpadding="0" cellspacing="0">
		...
		<tr>
			...
			<td>
				<% 
				if(com.app.docmgr.action.StatusAction.allowableAction.contains("edit")) { 
						if (privilegeList.contains("STATUS_EDIT")) { %>

					<input type="submit" value="<bean:message key="button.edit"/>" onclick="this.form.action.value='edit'" />
					&nbsp;
				<% 		}
					} %>
				<% if(com.app.docmgr.action.StatusAction.allowableAction.contains("delete")) { 
						if (privilegeList.contains("STATUS_DELETE")) { %>
