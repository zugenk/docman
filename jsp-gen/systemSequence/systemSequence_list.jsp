...
<% 
	...
	if(com.app.docmgr.action.SystemSequenceAction.allowableAction.contains("detail")) { 
		if (privilegeList.contains("SYSTEM_SEQUENCE_DETAIL")) {
			allowDetail=true;			
		}
	}
%>
...
<TABLE border="0" width="98%" align="center" cellpadding="3" cellspacing="1">
	...
	<tr>
		<td colspan="13" align="right">
		<% if(com.app.docmgr.action.SystemSequenceAction.allowableAction.contains("create")) { 
				if (privilegeList.contains("SYSTEM_SEQUENCE_CREATE")) { %>
