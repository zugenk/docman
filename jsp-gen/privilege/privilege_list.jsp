...
<% 
	...
	if(com.app.docmgr.action.PrivilegeAction.allowableAction.contains("detail")) { 
		if (privilegeList.contains("PRIVILEGE_DETAIL")) {
			allowDetail=true;			
		}
	}
%>
...
<TABLE border="0" width="98%" align="center" cellpadding="3" cellspacing="1">
	...
	<tr>
		<td colspan="13" align="right">
		<% if(com.app.docmgr.action.PrivilegeAction.allowableAction.contains("create")) { 
				if (privilegeList.contains("PRIVILEGE_CREATE")) { %>
