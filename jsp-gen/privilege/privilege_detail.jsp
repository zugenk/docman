...
<form name="privilege" action="privilege.do" method="POST">
	...
	<TABLE border="0" width="98%" align="center" cellpadding="0" cellspacing="0">
		...
		<tr>
			...
			<td>
				<% 
				if(com.app.docmgr.action.PrivilegeAction.allowableAction.contains("edit")) { 
						if (privilegeList.contains("PRIVILEGE_EDIT")) { %>

					<input type="submit" value="<bean:message key="button.edit"/>" onclick="this.form.action.value='edit'" />
					&nbsp;
				<% 		}
					} %>
				<% if(com.app.docmgr.action.PrivilegeAction.allowableAction.contains("delete")) { 
						if (privilegeList.contains("PRIVILEGE_DELETE")) { %>
