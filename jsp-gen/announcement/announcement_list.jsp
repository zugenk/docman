...
<% 
	...
	if(com.app.docmgr.action.AnnouncementAction.allowableAction.contains("detail")) { 
		if (privilegeList.contains("ANNOUNCEMENT_DETAIL")) {
			allowDetail=true;			
		}
	}
%>
...
<TABLE border="0" width="98%" align="center" cellpadding="3" cellspacing="1">
	...
	<tr>
		<td colspan="18" align="right">
		<% if(com.app.docmgr.action.AnnouncementAction.allowableAction.contains("create")) { 
				if (privilegeList.contains("ANNOUNCEMENT_CREATE")) { %>
