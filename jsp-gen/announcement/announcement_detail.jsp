	...
	<TABLE border="0" width="98%" align="center" cellpadding="0" cellspacing="0">
		...
		<tr>
			...
			<td>
				...
				<% if(com.app.docmgr.action.AnnouncementAction.allowableAction.contains("activate")) { 
						if (privilegeList.contains("ANNOUNCEMENT_ACTIVATE")) { %>
				...
				<% if(com.app.docmgr.action.AnnouncementAction.allowableAction.contains("block")) { 
						if (privilegeList.contains("ANNOUNCEMENT_BLOCK")) { %>
