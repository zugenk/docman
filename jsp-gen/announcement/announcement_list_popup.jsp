...
<html:html>
<HEAD>
<TITLE><bean:message key="page.Announcement.ListPopup"/></TITLE>
<!--
/**
...
<SCRIPT type="text/javascript" language="javascript">
	<!--
		...
		function doAddParent(val){
			var formName = document.forms.announcement.parentForm.value;
			var fieldName = document.forms.announcement.parentField.value;
