...
<% 
	...
	if(com.app.docmgr.action.NotificationAction.allowableAction.contains("detail")) { 
		if (privilegeList.contains("NOTIFICATION_DETAIL")) {
			allowDetail=true;			
		}
	}
%>
...
<TABLE border="0" width="98%" align="center" cellpadding="3" cellspacing="1">
	...
	<tr>
		<td colspan="11" align="right">
		<% if(com.app.docmgr.action.NotificationAction.allowableAction.contains("create")) { 
				if (privilegeList.contains("NOTIFICATION_CREATE")) { %>
