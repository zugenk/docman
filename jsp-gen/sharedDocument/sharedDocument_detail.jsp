	...
	<TABLE border="0" width="98%" align="center" cellpadding="0" cellspacing="0">
		...
		<tr>
			...
			<td>
				...
				<% if(com.app.docmgr.action.SharedDocumentAction.allowableAction.contains("activate")) { 
						if (privilegeList.contains("SHARED_DOCUMENT_ACTIVATE")) { %>
				...
				<% if(com.app.docmgr.action.SharedDocumentAction.allowableAction.contains("archive")) { 
						if (privilegeList.contains("SHARED_DOCUMENT_ARCHIVE")) { %>
				...
				<% if(com.app.docmgr.action.SharedDocumentAction.allowableAction.contains("block")) { 
						if (privilegeList.contains("SHARED_DOCUMENT_BLOCK")) { %>
