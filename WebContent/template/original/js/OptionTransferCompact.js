...
function clearSelectedOptions(from,to){if(!hasOptions(from) || !hasOptions(to)){return;}for(var i=(from.options.length-1);i>=0;i--){var tmpOpt=from.options[i];var found=false;for(var j=(to.options.length-1);j>=0 && !found;j--){if (tmpOpt.text==to.options[j].text) {to.options[j]=null;found=true;}}}to.selectedIndex = -1;from.selectedIndex = -1;}

/* SOURCE FILE: OptionTransfer.js */

function OT_markAll(){selectAllOptions(this.left)}
function OT_clearOptions(){clearSelectedOptions(this.left,this.right)}
